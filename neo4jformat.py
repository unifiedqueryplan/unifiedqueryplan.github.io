...
nodetype_neo4j = {
    ...
    'Skip': ['Executor', 'Skip'],
    'Sort': ['Bag', 'Sort'],
    'PartialSort': ['Bag', 'Sort Part'],
    'PartialTop': ['Bag', 'Sort Part'],
    'Top': ['Bag', 'Sort Part'],
    ...
    'Union': ['Bag', 'Union'],
    'AssertingMultiNodeIndexSeek': ['Bag', 'Unique'],
    'AssertSameNode': ['Bag', 'Unique'],
    'Distinct': ['Bag', 'Unique'],
    'OrderedDistinct': ['Bag', 'Unique'],
    ...
    def handle(self, json_subPlan):
        ...
        # Operator FILTER is merged into FILTER property of its child node which should only be one
            if len(json_subPlan.get('children')) == 1:
                ...
                new_node_properties[properties_neo4j['filter'][1]] = [properties_neo4j['filter'][0], json_subPlan.get('arguments').get('Details')]
