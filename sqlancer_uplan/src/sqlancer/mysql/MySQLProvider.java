...
public class MySQLProvider extends SQLProviderAdapter<MySQLGlobalState, MySQLOptions> {
    ...
    public String getQueryPlan(String selectStr, MySQLGlobalState globalState) throws Exception {
        ...
        SQLQueryAdapter q = new SQLQueryAdapter("EXPLAIN FORMAT=JSON " + selectStr, errors);
        ...
        if (!queryPlan.isEmpty()) {
            return DBMSCommon.parseQueryPlan(queryPlan, "mysql", "qpg", globalState.getOptions().getPathUplan());
        }
        else {
            return "";
        }
