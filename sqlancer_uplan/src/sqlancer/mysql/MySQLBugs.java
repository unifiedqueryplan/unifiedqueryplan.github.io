...
public final class MySQLBugs {
    ...
    // https://bugs.mysql.com/bug.php?id=113302
    public static boolean bug113302 = true;

    // https://bugs.mysql.com/bug.php?id=113304
    public static boolean bug113304 = true;

    // https://bugs.mysql.com/bug.php?id=113313
    public static boolean bug113313 = true;

    // https://bugs.mysql.com/bug.php?id=113317
    public static boolean bug113317 = true;
