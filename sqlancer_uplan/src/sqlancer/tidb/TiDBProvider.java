...
public class TiDBProvider extends SQLProviderAdapter<TiDBGlobalState, TiDBOptions> {
    ...
    public String getQueryPlan(String selectStr, TiDBGlobalState globalState) throws Exception {
        ...
        SQLQueryAdapter q = new SQLQueryAdapter("EXPLAIN FORMAT=tidb_json " + selectStr, errors);
        ...
        if (!queryPlan.isEmpty()) {
            return DBMSCommon.parseQueryPlan(queryPlan, "tidb", "qpg", globalState.getOptions().getPathUplan());
        }
        else {
            return "";
        }
