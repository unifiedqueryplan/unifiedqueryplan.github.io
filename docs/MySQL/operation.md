...
| duplicates_removal         | Bag      | [Link](https://github.com/mysql/mysql-server/blob/e57893fe/sql/opt_explain_json.cc#L108) | Remove duplicate data.                                                                                    |
...
| ordering_operation         | Bag      | [Link](https://github.com/mysql/mysql-server/blob/e57893fe/sql/opt_explain_json.cc#L126) | Sort data by specific keys.                                                                               |
...
| union_result               | Bag      | [Link](https://github.com/mysql/mysql-server/blob/e57893fe/sql/opt_explain_json.cc#L138) | Union results.                                                                                            |
