...
| ------------------- | -------- | ---------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| COMPOUND QUERY      | Bag      | [Link](https://github.com/sqlite/sqlite/blob/9089f060/src/select.c#L2923)    | Each component query of a compound query (UNION, UNION ALL, EXCEPT, or INTERSECT) is assigned and computed separately and is given its own line in the EXPLAIN QUERY PLAN output. |
...
| LEFT                | Bag      | [Link](https://github.com/sqlite/sqlite/blob/9089f060/src/select.c#L3637)    | The left query for a composed query.                                                                                                                                              |
| LEFT-MOST SUBQUERY  | Bag      | [Link](https://github.com/sqlite/sqlite/blob/9089f060/src/select.c#L2924)    | The left subquery is a composed query.                                                                                                                                            |
...
| MERGE               | Bag      | [Link](https://github.com/sqlite/sqlite/blob/9089f060/src/select.c#L3628)    | Merge the results of two queries.                                                                                                                                                 |
| MULTI-INDEX OR      | Bag      | [Link](https://github.com/sqlite/sqlite/blob/9089f060/src/wherecode.c#L2272) |  OR optimization, in which there will be a single top-level record for the search, with two sub-records, one for each index:                                                      |
...
| RIGHT               | Bag      | [Link](https://github.com/sqlite/sqlite/blob/9089f060/src/select.c#L3652)    | The right query for a composed query.                                                                                                                                             |
